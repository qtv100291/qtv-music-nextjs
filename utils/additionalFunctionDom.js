function setDimension(source, target) {
  //set element target dimension is equal to element source dimension
...
function checkhtmlHeight() {
  ...
  // console.log(htmlHieght + footerHieght , windowHeight)
  if (htmlHieght < windowHeight)
